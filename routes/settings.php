...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('settings/toko', [StoreController::class, 'edit'])->name('store-settings.edit');
    Route::put('settings/toko', [StoreController::class, 'update'])->name('store-settings.update');
});
